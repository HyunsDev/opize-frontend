        ...
        <Footer>
            <Footer.Nav>
                <Footer.Nav.Item>
                    ...
                    <Footer.Nav.A href="/@info">소개</Footer.Nav.A>
                    <Footer.Nav.A href="/@help">도움말</Footer.Nav.A>
                </Footer.Nav.Item>
                ...
                <Footer.Nav.Item>
                    ...
                    <Footer.Nav.A href="/@developer">개발자</Footer.Nav.A>
                    <Footer.Nav.A href="https://design.opize.me">디자인 시스템</Footer.Nav.A>
                    <Footer.Nav.A href="/@brand-resource">브랜드 리소스</Footer.Nav.A>
                </Footer.Nav.Item>
            </Footer.Nav>
            <Footer.Menu>
                <Footer.Menu.Item>
