        ...
        <ProjectDiv status={props.status}>
            ...
            <Right>
                <PlanInfo>
                    ...
                    <NextPayment>{t('user_payment_subscribe_next_payment')} {dayjs(props.nextPaymentDate).format('YYYY.MM.DD')} - {props.product.prices[user.currency]}{user.currency}</NextPayment>
                </PlanInfo>
            </Right>
        </ProjectDiv>
    )
