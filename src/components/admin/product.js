    ...
    return (
        <ProjectDiv>
            ...
            <Desc isFold={isFold}>
                ...
                <Options key='option'>
                    {props.paymentKind === 'billing' ? <A to={`/subscribe?projectCode=${props.projectCode}&productCode=${props.code}`}>구독</A>
                        : <A to={`/payment?projectCode=${props.projectCode}&productCode=${props.code}`}>구매</A>}
